            ...
            <div class="glass p-4">
                ...
                <form id="registerForm" class="row g-3">
                    <div class="col-12">
                        ...
                        <input id="name" type="text" class="form-control form-control-lg" required
                    ...
                    <div class="col-12">
                        ...
                        <input id="password" type="password" class="form-control form-control-lg" required minlength="6"
